  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const motion_capture_tracking_interfaces__msg__NamedPoseArray * ros_message = static_cast<const motion_capture_tracking_interfaces__msg__NamedPoseArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_motion_capture_tracking_interfaces__msg__NamedPoseArray(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  motion_capture_tracking_interfaces__msg__NamedPoseArray * ros_message = static_cast<motion_capture_tracking_interfaces__msg__NamedPoseArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_motion_capture_tracking_interfaces__msg__NamedPoseArray(cdr, ros_message);
}
