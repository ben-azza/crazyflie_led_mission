...
static const _LatencyInfo_type_support_symbol_names_t _LatencyInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motion_capture_tracking_interfaces, msg, LatencyInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motion_capture_tracking_interfaces, msg, LatencyInfo)),
  }
};
...
{
  return &::motion_capture_tracking_interfaces::msg::rosidl_typesupport_cpp::LatencyInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, motion_capture_tracking_interfaces, msg, LatencyInfo)() {
  return get_message_type_support_handle<motion_capture_tracking_interfaces::msg::LatencyInfo>();
}
